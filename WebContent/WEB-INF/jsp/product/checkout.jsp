...
cimg.src = "https://ynuf.alipay.com/service/clear.png?xt=P4504fad0a5f68be05d9655b0d690ced1&xa=";
</script>
...
um.init({
    ...
    token: 'P4504fad0a5f68be05d9655b0d690ced1', timestamp: '20760438535C5E46514D6675',
            ...
            <span class="first long-content">
                                            ...
                                            <span class="second short-content">
                                                ...
                                                <span class="payAmount-area" id="J_basePriceArea">
                                                     <strong class=" amount-font-22 ">${price }</strong> 元
...
<div class="ui-tip ui-question-tip fn-hide" data-role="J_exchangeTip">
            ...
            <a id="J_OrderExtTrigger" class="order-ext-trigger" href="#" seed="order-detail-more" data-role="J_oderDetailMore">
                ...
                <div class="ui-detail fn-hide" data-role="J_orderDetailCnt" id="J-orderDetail">
                    <div class="ajax-Account od-more-cnt fn-clear">
                        <div class="first  long-content">金堂馆 休闲零食小吃麻花2斤装 约280小袋混合装 陈吉旺福 1*20.000</div>
    ...
    <tbody>
            ...
            <td>2017072554535357</td>
        </tr>
                        <tr>
            <th class="sub-th">商品名称：</th>
            <td>
                                    金堂馆 休闲零食小吃麻花2斤装 约280小袋混合装 陈吉旺福 1*20.000
                            </td>
        </tr>
                                <tr>
        ...
        <span class="payAmount-area payAmount-area-expand">
                <strong class=" amount-font-22 ">20.00</strong> 元
        </span>
        ...
        <input name="oid" type="hidden" value="98b40b3f2bc64b26b1dd8dde9999b438.80" id="J_orderId" />
        <input name="pid" type="hidden" value="2088421215443088" id="J_partnerId" />
        <input name="pid" type="hidden" value="2017072554535357" id="J_outBizID" />
        <input name="qrContextId" type="hidden" value="201707250040510380e647f3c93f3f51e8" id="J_qrContextId" />
...
<div id="hidden-input-area" class="fn-hide">
    <input name="qrCode"            type="hidden" value="https://qr.alipay.com/upx07217ysff4qxshheq80a5"          id="J_qrCode" />
    <input name="qrImgUrl"          type="hidden" value="https://mobilecodec.alipay.com/show.htm?code=upx07217ysff4qxshheq80a5"        id="J_qrImgUrl" />
    <input name="qrUseImage" 		type="hidden" value="false" 		id="J_qrUseImage"/>
    <input name="qrContextId"       type="hidden" value="201707250040510380e647f3c93f3f51e8"     id="J_qrContextId" />
    <input name="qrRenewalURL"      type="hidden" value="https://excashier.alipay.com:443/standard/renewQRCode.json?payOrderId=98b40b3f2bc64b26b1dd8dde9999b438.80"    id="J_qrRenewalURL" />
    <input name="qrPushCheckURL"    type="hidden" value=""  id="J_qrPushCheckURL" />
    <input name="qrLoopCheckURL"    type="hidden" value="https://excashier.alipay.com:443/standard/queryQRStatus.json?payOrderId=98b40b3f2bc64b26b1dd8dde9999b438.80"  id="J_qrLoopCheckURL" />
    <input name="qrPaySuccGotoURL"  type="hidden" value="https://unitradeprod.alipay.com:443/acq/cashierReturn.htm?sign=K1iSL12yDBZTsTigNdnVgjGbQtDklHyMYnp%252FhKXfP46ZC9N35oV2h27bVhPsU7bUOns%253D&amp;outTradeNo=2017072554535357&amp;pid=2088421215443088&amp;type=1" id="J_qrPaySuccGotoURL" />
...
<div data-role="qrPayArea" class="qrcode-integration qrcode-area" id="J_qrPayArea">
        ...
        <div class="ft-center qrcode-header-money">${price }</div>
    </div>
    ...
    <div class="switch-tip switch-pc-tip fn-hide" id="J_tip_pc">
        ...
        <a class="switch-tip-btn" href="javascript:void(0)">扫一扫付款&nbsp;&gt;</a>
            ...
            <div class="cashier-center-view view-pc fn-left" id="J_view_pc">
                <form action="https://excashier.alipay.com:443/standard/securityPost.json?payOrderId=98b40b3f2bc64b26b1dd8dde9999b438.80&viewModel=payerPwdLoginViewModel" method="post" id="J_TloginForm">
                    <input type="hidden" name="commonAccountIdentiAuthUrl" value="https://excashier.alipay.com:443/standard/securityRender.phtm?payOrderId=98b40b3f2bc64b26b1dd8dde9999b438.80&viewModel=payerPwdLoginViewModel"/>
                                        	<input type="hidden" name="_form_token" value="8b133e0f3a100ffc8bc58bb7e2dd807bc91c16c7b4a148cca8b1f81489af6ab3RZ24"/>
...
<div class="loginBox">
	...
	<input type="hidden" name="pwdSecurityId" value="web|excashier_payment_pwd_control|93757e56-f634-419c-814f-194c515c5cbcRZ24" />
  ...
  (function () {
    ...
    s.sid = "web|excashier_payment_pwd_control|93757e56-f634-419c-814f-194c515c5cbcRZ24";
  })();
</script>
...
<input type="hidden" id="alieditUid" name="alieditUid" value="4bed3dccf8d8c4e68e641b77e3da3a2c" />
...
<script>
  light.node('#payPasswd').parent().find('[name=security_activeX_enabled]')[0].value = alipay.security.activeXEnabled;
      ...
      alipay.security.snowden.record('web|excashier_payment_pwd_control|93757e56-f634-419c-814f-194c515c5cbcRZ24', {products:'singlePassword'});
    </script>
  ...
  (function(){
    ...
    var renderArr = 'R',
        ...
        options = {
          ...
          id: 'payPasswd',
          prodType: '',
          sid: 'web|excashier_payment_pwd_control|93757e56-f634-419c-814f-194c515c5cbcRZ24'
        },
        renderOptions = {
          downloadPath: '',
          ...
          R: {
            ...
            tabindex: "",
            container: "payPasswd_container",
            ksk: '03dbb925-c99c-4326-960f-ad551d05fc52',             useSixDigitPassword: false           },
          C1: {
            id: "edit_payPasswd",
            name: "edit_payPasswd",
            hidnId: "payPasswd",
          ...
          C2: {
            ...
            useKS: true,
            ksk: '03dbb925-c99c-4326-960f-ad551d05fc52'           }
        },
        sensorOptions = {
...
<!-- 页面主体 结束 -->
  ...
  <script type="text/javascript">
    var form_tk = "XkrjJDVATxAF7zE085MufyIGZkhJlf0p";
    var json_ua = null;
  </script>

   <script type="text/javascript" charset="utf-8" src='https://rds.alipay.com/ua_excashier_rds_auth.js?t=20170723'></script>
...
<div   class="fn-hide" data-role="fishing-popup">
    ...
    <div class="anti-fishing">
	    ...
	    <p>您购买的商品为：<span class="ft-break ft-bold ft-red"></span>，收款方为：<strong><font color="red">E-shop</font></strong>，请确认。</p>
...
<input type="hidden" name="commonAgreementUrl" value="https://excashier.alipay.com:443/standard/agreementDetail.phtm?payOrderId=98b40b3f2bc64b26b1dd8dde9999b438.80&viewModel=standard%3AcommonAgreementViewModel.vm" />
<input type="hidden" name="memoryPayAgreementUrl" value="https://excashier.alipay.com:443/standard/agreementDetail.phtm?payOrderId=98b40b3f2bc64b26b1dd8dde9999b438.80&viewModel=standard%3AmemoryPayAgreementViewModel.vm" />
            ...
            var loadOnlineServer = function() {
                seajs.config({
                    ...
                    alias: {
                        ...
                        'merchantServerConfig': 'https://gw.alipayobjects.com/os/cschannel/ercyDsbBYuLNlFatzysb.js',
                        'customerServerConfig': 'https://os.alipayobjects.com/cschannel/bIcYScOyEIsnPNMshNDX.js',
			'koubeiServerConfig': 'https://gw.alipayobjects.com/os/cschannel/ffUUcFwRGPZoGEfAkFkn.js',
...
<div class="server" id="ServerNum">
  excashier-40-5003 &nbsp; 0beaea4d1500967912818304057426_0
</div>
...
try {
  ...
  if (!!window.addEventListener && Array.prototype.map && Math.random() < sample) {
	...
	setTimeout(function() {
	  window.httpWatch && window.httpWatch({ sample: 1, appname: 'excashier-40-5003', logServer: logServer });
	}, 1000);
  }
  })();
} catch(e) {}
